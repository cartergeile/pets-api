...
const toySchema = new mongoose.Schema({
  ...
  condition: {
    type: String,
    // here well use enum, which means we can only use specific strings for this field
    // enum is a validation on the type String that says "you can only use one of the values within this array"
